const { findUserInDatabase, getUserDataFromDatabase, getFriendshipData, sendFriendshipRequestInDatabase, handleIncomingRequestsInDatabase } = require('../../app/user/user.data-access');
